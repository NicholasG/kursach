INSERT INTO developer_info(name, country, city, street, zipcode, phone_number, website, email, fax)
  VALUES('Михайло', 'Україна', 'Івано-Франківськ', 'Сагайдачного 26', '00073', '0965727366', 'mihalich.if.com', 'mishka.b@gmail.com', '034309');
INSERT INTO developer_info(name, country, city, street, zipcode, phone_number, website, email, fax)
  VALUES('Лёха', 'Россия', 'Петербург', 'Мартовская 8', '04777', '7089673456', 'whereislesha.ru', 'aleksaner.br@mail.ru', '77234');
INSERT INTO developer_info(name, country, city, street, zipcode, phone_number, website, email, fax)
...
INSERT INTO developer_info(name, country, city, street, zipcode, phone_number, website, email, fax)
  VALUES('Google', 'USA', 'Каліфорнія', 'Silicon Valley', '55232', '555333', 'google.com', 'supportgogle@gmail.com', '552002');

INSERT INTO license_info(name, minimum_users, maximum_users, expiration, price_for_one, price_for_ten, price_for_hundred, type)
  VALUES('license1', 1, 100, 256, 0, 0, 0, 0);
INSERT INTO license_info(name, minimum_users, maximum_users, expiration, price_for_one, price_for_ten, price_for_hundred, type)
  VALUES('license2', 1, 1000, 356, 499.99, 3999.99, 29999.99, 1);
INSERT INTO license_info(name, minimum_users, maximum_users, expiration, price_for_one, price_for_ten, price_for_hundred, type)
